# Write a program that reads a file in the same 
# format as ch07/babynames.txt and prints all names that are both 
# boy and girl names (such as Alexis or Morgan).
##
...
def main() :
   ...
   unisexNames = ""
   for boysLine in list(boysFile):
          if boysLine in list(girlsFile):
              unisexNames += boysLine + "\n"
